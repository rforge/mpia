...
save(dtms, file="~/Documents/denkfabrik/dissertation/workodrome-II/examples-essayscoring/dtms-essaysonly-full.RData")
...
save(dtmsred, file="~/Documents/denkfabrik/dissertation/workodrome-II/examples-essayscoring/dtms-essaysonly-full-globfreq1up25pctdown.RData")
...
save(dtm, file="~/Documents/denkfabrik/dissertation/workodrome-II/examples-essayscoring/dtm-essaysonly-trimmed.RData")
...
save(space, file="~/Documents/denkfabrik/dissertation/workodrome-II/examples-essayscoring/space-essaysonly-raw.RData")
